<template>
  <div class="container column" style="position: relative">
    <TopBar class="topBar" style="position: relative">
      <div
        class="row"
        style="margin: 0.9375rem 1.25rem; justify-content: space-between"
      >
    ...
    <div class="view column" style="position: absolute; top: 6.75rem">
      ...
      <div
        ...
        style="padding: 2.5rem 0.625rem 0.625rem 0.625rem; position: relative"
      >
        <img
      ...
      <OperationBar style="width: 100%; margin-top: 15px" :datas="rowButtons" />
  ...
  data() {
    return {
      rowButtons: [
        {
          title: "历史记录",
          iconUrl: require("@/assets/svg/user/histroy.svg"),
          routeName: undefined,
        },
        {
          title: "我的订单",
          iconUrl: require("@/assets/svg/user/trade_list.svg"),
          routeName: undefined,
        },
        {
          title: "我的关注",
          iconUrl: require("@/assets/svg/user/attention.svg"),
          routeName: undefined,
        },
      ],
      options: [
        {
          title: "我的需求",
          iconUrl: require("@/assets/svg/user/protocol.svg"),
          routeName: undefined,
        },
        {
          title: "我的收藏",
          iconUrl: require("@/assets/svg/user/collect.svg"),
          routeName: "CollectionPage",
        },
        {
          title: "我的客服",
          iconUrl: require("@/assets/svg/user/headset.svg"),
          routeName: undefined,
        },
        {
          title: "意见与反馈",
          iconUrl: require("@/assets/svg/user/notepad.svg"),
          routeName: undefined,
        },
      ],
    };
